...
class Game
  ...
  def initialize args
    ...
    @s.events = {
      ...
      356  => -> { @s.aircrafts["N91AST"].radar_target.contact_lost = true},
      357  => -> { @s.aircrafts["N91AST"].altitude = 4400},
      358  => -> { @s.aircrafts["N91AST"].heading = 240},
      359  => -> { @s.aircrafts["N91AST"].ias = 98},
      361  => -> { @s.aircrafts["N91AST"].radar_target.contact_lost = false},
      362  => -> { @s.aircrafts["N91AST"].altitude = 4200},
      363  => -> { @s.aircrafts["N91AST"].heading = 220},
